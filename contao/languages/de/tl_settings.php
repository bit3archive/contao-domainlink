...
$GLOBALS['TL_LANG']['tl_settings']['traceDomainLink']         = array('Entwicklermodus', 'Hiermit wird der Tracing und Entwicklermodus von DomainLink aktiviert. Ist dieser aktiviert logt DomainLink zu jedem Request sein Verhalten in ein Log File, dass unter system/logs/traceDomainLink-X.log zu finden ist.');
$GLOBALS['TL_LANG']['tl_settings']['forceAbsoluteDomainLink'] = array('Absolute Adressen erzwingen', 'Aktivieren Sie diese Option werden alle Links in absolute Links konvertiert.');
